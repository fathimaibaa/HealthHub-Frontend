...
export const BASE_URL = "https://healthhub-backend-7hwp.onrender.com/api/";  // For API requests
export const SERVER_URL = "https://healthhub-backend-7hwp.onrender.com/";  // For server-side operations like WebSockets
