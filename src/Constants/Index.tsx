...
export const BASE_URL = "https://healthhub-backend-l4qe.onrender.com/api/";  // For API requests
export const SERVER_URL = "https://healthhub-backend-l4qe.onrender.com/";  // For server-side operations like WebSockets
