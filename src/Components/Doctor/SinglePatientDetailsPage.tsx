            ...
            {patient.appoinmentStatus === "Booked" || patient?.appoinmentStatus == "Consulted" || patient?.appoinmentStatus == "unConsulted"  ? (
              <>
                ...
                <div className="p-4 bg-gray-50 rounded-lg shadow-inner">
                  ...
                  <button className={`bg-purple-500 text-white py-2 px-4 rounded-md shadow hover:bg-purple-700 flex items-center mt-3 ${isVideoCallDisabled ? 'opacity-50 cursor-not-allowed' : ''}`}
                        onClick={invite}
                ...
                <div className="p-4 bg-gray-50 rounded-lg shadow-inner">
                  ...
                  {patient && patient.appoinmentStatus === "Booked" && (
                    <div className="mt-6 flex justify-center space-x-4">
                      <button
                        className="bg-purple-500 text-white py-2 px-6 rounded-md shadow hover:bg-purple-700"
                ...
                <div className="flex justify-center items-center mt-4 md:col-span-2">
                  {prescription ? (
                   ...
                   <button
                    className="bg-purple-900 text-white py-2 px-4 rounded-md shadow hover:bg-purple-800 flex items-center ml-5"
